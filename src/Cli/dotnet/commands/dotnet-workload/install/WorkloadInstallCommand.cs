...
namespace Microsoft.DotNet.Workloads.Workload.Install
{
    internal class WorkloadInstallCommand : CommandBase
    {
            ...
            : base(parseResult)
        {
            ...
            _sdkVersion = WorkloadOptionsExtensions.GetValidatedSdkVersion(parseResult.GetValueForOption<string>(WorkloadInstallCommandParser.VersionOption), version, _dotnetPath);
