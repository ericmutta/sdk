...
namespace Microsoft.DotNet.Workloads.Workload.Repair
{
    internal class WorkloadRepairCommand : CommandBase
    {
            ...
            : base(parseResult)
        {
            ...
            _sdkVersion = WorkloadOptionsExtensions.GetValidatedSdkVersion(parseResult.GetValueForOption<string>(WorkloadRepairCommandParser.VersionOption), version, _dotnetPath);
