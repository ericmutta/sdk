...
namespace Microsoft.DotNet.Workloads.Workload.Update
{
    internal class WorkloadUpdateCommand : CommandBase
    {
            ...
            : base(parseResult)
        {
            ...
            _sdkVersion = WorkloadOptionsExtensions.GetValidatedSdkVersion(parseResult.GetValueForOption<string>(WorkloadUpdateCommandParser.VersionOption), version, _dotnetPath);
